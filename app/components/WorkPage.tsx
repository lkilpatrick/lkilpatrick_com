...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    matters: "Not a demo. A real product running on a real property solving a real operational gap. Shows full-stack depth across web, mobile, backend, and docs — plus product thinking that starts with a lived problem.",
